const componentGenerator = {
  ...
  actions: ({ stateless }) => {
    const actions = [
      {
        type: 'add',
        path: '../src/components/{{properCase type}}s/{{properCase name}}/index.tsx',
        templateFile: './index.tsx.hbs',
        abortOnFail: true,
      },
      {
        type: 'add',
        path: '../src/components/{{properCase type}}s/{{properCase name}}/{{properCase name}}.tsx',
      ...
      {
        type: 'add',
        path: '../src/components/{{properCase type}}s/{{properCase name}}/{{properCase name}}.test.tsx',
        templateFile: './componentName.test.tsx.hbs',
        abortOnFail: true,
      },
      {
        type: 'add',
        path: '../src/components/{{properCase type}}s/{{properCase name}}/{{properCase name}}.stories.tsx',
